...
PROJECT = {
  "code": "P07",
  "slug": "primes-times-table-lab",
  "title": "Primes Times Table Lab",
  "discipline": "Logic and Programming Language I",
  "disciplinePt": "Logica e Linguagem de Programacao I",
  "difficulty": "Introductory",
  "difficultyPt": "Introdutorio",
  "kind": "primes",
  "dataset": "Generated numeric sample",
  "source": "Local deterministic generation",
  "description": "Python logic lab for multiplication tables, prime checks, and a simple sieve.",
  "concepts": [
    "for loops",
    "while loops",
    "range",
